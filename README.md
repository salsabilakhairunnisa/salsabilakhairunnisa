Halo, saya Salsabila Khairunnisa 👋

Mahasiswa tingkat akhir Matematika, IPB University | Tertarik pada Data Processing, Statistical Analysis, dan Time Series Modeling

🎓 Tentang Saya

Saya mahasiswa Matematika IPB University (Agustus 2022 – September 2026) dengan pengalaman di pengolahan data, analisis statistik, dan kegiatan administratif melalui proyek akademik maupun organisasi kemahasiswaan. Terbiasa mengolah dan menyusun dataset, membuat laporan, serta mendukung kerja tim menggunakan Microsoft Excel, Python, dan Looker Studio. Detail-oriented, analitis, dan senang belajar hal baru sambil berkontribusi dalam kegiatan operasional dan pengelolaan data.

Skripsi: Model Autoregressive Distributed Lag dalam Analisis Sensitivitas Produksi Padi dan Jagung terhadap Variabilitas Iklim di Jawa Tengah
...
🌦️ ARDL untuk Sensitivitas Iklim terhadap Produksi Pangan
